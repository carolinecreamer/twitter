  ...
  return (
    ...
    <div className="tweet" data-tweet-id={tweet.id}>
      ...
      <div className="tweet-content">
        <TweetUserInfo key="tweetUserInfo" name={tweet.name} handle={tweet.handle}/>
        <p className="tweet-text">{tweet.text}</p>
        <TweetFooter key="tweetFooter" numComments={tweet.comments} numRetweets={tweet.retweets} numLikes={tweet.likes}/>
      </div>
    </div>
  )
}
